...
public class ControllerExceptionHandler {
    ...
    @ExceptionHandler(BusinessExceptionService.class)
    public ResponseEntity<StandardError> AlreadyEmailException(BusinessExceptionService e, HttpServletRequest request) {
